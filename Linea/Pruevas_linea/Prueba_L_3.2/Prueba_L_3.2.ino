...
// Velocidades del servomotor derecho
int velDConA3 = 130;//180
int velDConA2 = 120;//150
int velDConA1 = 110;//120
int velDNeutra = 90;//90
int velDConB1 = 83;//60
int velDConB2 = 77;//30
int velDConB3 = 69;//0

// Velocidades del servomotor izquierdo
int velIConA3 = 180;//180
int velIConA2 = 150;//150
int velIConA1 = 130;//120
int velINeutra = 90;//90
int velIConB1 = 50;//60
int velIConB2 = 20;//30
int velIConB3 = 0;//0
...
void Moverse(int auxVI, int auxVD)
{
    ...
    */
    ...
    int VD;
    // Izquierdos
    if (auxVI == 3){VI = velIConB3;}else if (auxVI == 2){VI = velIConB2;}else if (auxVI == 1){VI = velIConB1;}
    else if (auxVI == 0){VI = velINeutra;}
    else if (auxVI == -1){VI = velIConA1;} else if (auxVI == -2){VI = velIConA2;}else if (auxVI == -3){VI = velIConA3;}
    // Derechos
    if (auxVD == 3){VD = velDConA3;}else if (auxVD == 2){VD = velDConA2;}else if (auxVD == 1){VD = velDConA1;}
    else if (auxVD == 0){VD = velDNeutra;}
    else if (auxVD == -1){VD = velDConB1;}else if (auxVD == -2){VD = velDConB2;}else if (auxVD == -3){VD = velDConB3;}
