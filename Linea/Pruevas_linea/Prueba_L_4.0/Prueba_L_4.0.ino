...
// Definicion de los errores de la linea de las condicionales y del control PID
...
void direccion()
{
  ...
  */
  if (
      //--BBNNNN
      (digital[1] == 0 && digital[2] == 0 && digital[3] == 0 && digital[4] == 1 && digital[5] == 1 && digital[6] == 1 && digital[7] == 1) ||
      //--BNNNNN
      (digital[1] == 0 && digital[2] == 0 && digital[3] == 1 && digital[4] == 1 && digital[5] == 1 && digital[6] == 1 && digital[7] == 1))
  {
      errorActual = "V9D";
      errorAnterior = errorActual;
  ...
  */
  if (
      // NNNNBB--
      (digital[0] == 1 && digital[1] == 1 && digital[2] == 1 && digital[3] == 1 && digital[4] == 0 && digital[5] == 0 && digital[6] == 0 ) ||
      // NNNNNB--
      (digital[0] == 1 && digital[1] == 1 && digital[2] == 1 && digital[3] == 1 && digital[4] == 1 && digital[5] == 0 && digital[6] == 0 ))
  {
      errorActual = "V9I";
      errorAnterior = errorActual;
